...
public class SortTest extends TestTemplate
{
	...
	@Test
	public AppCalendar sortTest() throws UsernameAlreadyExistException, UnknownUserException, AccessDeniedException, InvalidDateException, UnknownCalendarException, UnknownEventException, ParseException, CalendarIsNotUniqueException
	{
